# Generated by Django 3.0.8 on 2020-08-23 18:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_text', models.CharField(blank=True, max_length=140)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('liker', models.ManyToManyField(related_name='likes', to=settings.AUTH_USER_MODEL)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='likers', to='climate_wavers.Post')),
            ],
        ),
        migrations.CreateModel(
            name='Follower',
